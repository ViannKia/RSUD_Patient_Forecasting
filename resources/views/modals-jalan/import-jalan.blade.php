 ...
 <div class="modal fade" id="modalimportJalan" tabindex="-1" aria-labelledby="modalimportLabel" aria-hidden="true">
     <div class="modal-dialog">
         <div class="modal-content">
             <form action="{{ url('/rawatjalan/import') }}" method="POST" enctype="multipart/form-data"
                 id="formImportJalan">
                 <input type="file" name="file" id="fileInputJalan" style="display: none;">
                 @csrf
                 <div class="modal-header">
                     <h5 class="modal-title" id="modalimportLabel">Import Data Rawat Jalan</h5>
        ...
        const myDropzone = new Dropzone("#excelDropzone", {
            ...
            init: function() {
                this.on("addedfile", function(file) {
                    ...
                    document.getElementById('fileInputJalan').files = dataTransfer.files;
